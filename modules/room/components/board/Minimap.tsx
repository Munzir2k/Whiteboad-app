...
const MiniMap = ({ dragging }: { dragging: boolean }) => {
	...
	return (
		<div
			className='absolute right-10 top-10 z-30 overflow-hidden rounded-lg bg-zinc-100 shadow-lg'
			style={{
		...
		>
			...
			<motion.div
				...
				className='absolute top-0 left-0 cursor-grab rounded-lg border-2 border-green-500'
				style={{
					width: width / divider,
